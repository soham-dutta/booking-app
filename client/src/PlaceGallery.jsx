...
export default function PlaceGallery({ place }) {
        ...
        <div className="bg-black p-8 grid gap-4">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="py-2 px-4 rounded-2xl shadow bg-white text-black flex items-center gap-1"
            >
              <svg
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className="flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow-md text-black"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
